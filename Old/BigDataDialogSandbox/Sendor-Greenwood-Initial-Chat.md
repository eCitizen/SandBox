...
**Dazza:**  To that end, I request and invite your collaboration on this new and better tuned "Show" concept for the BigDataDialog... and have put these gems in your special comfy sandbox:
https://github.com/eCitizen/SandBox/blob/master/BigDataDialogSandbox/Sendor-Greenwood-Initial-Chat.md
and
 Sent at 9:53 PM on Tuesday
 
**David:**  I cannot access that link

**Dazza:**  https://github.com/eCitizen/SandBox/blob/master/BigDataDialogSandbox/BigDataDialogConcept.md
hmmm
 
**David:**  both links give me a 404 error

**Dazza:**  what is your GitHub id again?  i think you need to be logged in to gain access unless you changed ID.  The account I had from you before is on a team w/access to this repo.
 
**David:**  hmm, let me try again
ahh, I thought I was logged in
Now I can read them
 Sent at 9:56 PM on Tuesday
 
**David:**  OK, so there is a lot here
I think the key next step is to figure out a technical method of hosting a combo version control and voting system
Doing a bit of googling has yielded nothing
...
**David:**  definitely. 
let me think through this a bit

**Dazza:**  Awesome... is there anything you want?
in my power to provide or influence, at least?
 
**David:**  Um, well there are lots of things

**Dazza:**  let's have them, please
 
**David:**  well, I cannot think of any in your power to provide
world peace for instance
...
but, I think for now it would be good to see some of the ideas that people have brought up
that might give us some ideas

**Dazza:**  ok - I will do the following:
1. Seek a time convenient for you to check in soon-ish on what we have turned up and next steps...
2. I will start developing and posting the ideas so far from th eworkshops and other sources connected to this initiative
3. I will seek time with Sandy to do a "demo" of this and have time for brain storming/ feedback/etc.
 
**David:**  great

**Dazza:**  4. I will ask you how much attribution/celebration you seek.  (there are only 4).
 
**David:**  I will focus on thinking through some fairly simple technical aspects of creating this collaboration platform easily
I am not a web programmer, so we need something plug and play
i will also review and think through the ideas that you post
is there anything else that you think I should focus on?

**Dazza:**  Re #4: I would like to create a "People" or "Team" menu item on BigDataDialog and list you as something.  What title on the project would you like (why not "Data Scientist" or something cooler?) and is there a bio page such as linked in or this meetup page I can link to/ copy from?  http://www.meetup.com/Predictive-Analytics/members/47708332/
 Sent at 10:11 PM on Tuesday

**Dazza:**  ------
 Sent at 10:12 PM on Tuesday

**Dazza:**  If you prefer, you can have no footprint or some other type of attribution.  But usually people like/want/value a nice profile page on a Media Lab project and so... it being in my power - it is your for the taking.  I would also enjoy seeing you get credit and seeing your name on this neat little transformational use of Data Science for the public good.
 
**David:**  Data scientist is fine. I will put together a short bio. I don't have anything good for this type of thing, 

**Dazza:**  No probs.  Data Scientist it is.  And with pleasure.... So that brings us to the very last little item... the task master of time:
 Sent at 10:15 PM on Tuesday

**Dazza:**  Is there any convenient moment perhaps tomorrow everning when we could check in re your ideas and progress made identifying existing ideas (including Sandy's majr idea on need for a "New Deal on Data") and w/White House etc here.
Or any time, actually.
 
**David:**  We can check in briefly tomorrow evening after 8. I may also have time Thursday evenining, but I'm not sure yet. Otherwise I could find a time next week.
I probably won't be able to complete that much until Sunday though
but it would be valuable to just let the ideas percolate
 Sent at 10:18 PM on Tuesday

**Dazza:**  Yes, that would be great.  A very brief check in tomorrow night after 8 would be splendid.  I will be headed to dinner with an old friend but can/will check in briefly.  Overall, I sense April 1-ish is the right "Launch" target date for this because it is the date of the 3rd/final White House in-person workshop at Berkeley and the day after public comments are due (and all the comments submitted will themselves form a terrific source of data).  So... that's what I've got!
 
**David:**  Great. I will send you an invite for tomorrow evening

**Dazza:**  Last last thingy - I'd like to move the future files and stuff to a public GitHub repo (not the private sandbox). I set up BigDataDialog as an organization and can provision you team access.  Are you cool with doing some iteration in GitHub in public (nothing political or scary, please)?
 
**David:**  no problem
 Sent at 10:23 PM on Tuesday

**Dazza:**  Excellent.  I shall point the resources to the repo and use issue tickets to remain transparent on stuff.  I invite you to contribute whatever you think useful (platform research, other ideas, etc) to the repo as well please.  And I wish you a very good night  
 
**David:**  great. Good night!
